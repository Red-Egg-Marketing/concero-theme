 ...
 */
import { castArray, flatMap, first, get, includes, isArray, isBoolean, last, map, orderBy, reduce, some, find, filter } from 'lodash';
...
export var INSERTER_UTILITY_HIGH = 3;
/**
 * @private
 */

export var INSERTER_UTILITY_MEDIUM = 2;
/**
 * @private
 */

export var INSERTER_UTILITY_LOW = 1;
/**
 * @private
 */

export var INSERTER_UTILITY_NONE = 0;
...
var canInsertBlockTypeUnmemoized = function canInsertBlockTypeUnmemoized(state, blockName) {
  ...
  var parentAllowedBlocks = get(parentBlockListSettings, ['allowedBlocks']);
...
export var getInserterItems = createSelector(function (state) {
  ...
  var buildBlockTypeInserterItem = function buildBlockTypeInserterItem(blockType) {
    ...
    var isContextual = isArray(blockType.parent);
  ...
  var reusableBlockInserterItems = canInsertBlockTypeUnmemoized(state, 'core/block', rootClientId) ? getReusableBlocks(state).map(buildReusableBlockInserterItem) : [];
  return orderBy([].concat(_toConsumableArray(blockTypeInserterItems), _toConsumableArray(reusableBlockInserterItems)), ['utility', 'frecency'], ['desc', 'desc']);
