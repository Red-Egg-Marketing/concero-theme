 ...
 */
import { map, includes, filter, findIndex, flow, sortBy, groupBy, isEmpty } from 'lodash';
/**
...
function InserterBlockList(_ref3) {
  ...
  var childItems = useMemo(function () {
    return filter(filteredItems, function (_ref4) {
      var name = _ref4.name;
  ...
  var itemsPerCategory = useMemo(function () {
    ...
    return flow(function (itemList) {
      return filter(itemList, function (item) {
