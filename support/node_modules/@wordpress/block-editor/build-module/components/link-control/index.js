...
import { useRef, useCallback, useState, Fragment, useEffect, createElement, useMemo } from '@wordpress/element';
...
function LinkControl(_ref) {
  ...
  var handleSelectSuggestion = function handleSelectSuggestion(suggestion) {
    ...
    setIsEditingLink(false);
    onChange(_objectSpread({}, _value, {}, suggestion));
  }; // Render Components
  ...
  var viewerSlotFillProps = useMemo(function () {
    return {
      url: value && value.url
    };
  }, [value && value.url]);
