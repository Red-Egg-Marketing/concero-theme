...
export var BlockList = /*#__PURE__*/function (_Component) {
  ...
  _createClass(BlockList, [{
    ...
    value: function renderDefaultBlockAppender() {
      ...
      }, createElement(ReadableContentView, null, createElement(BlockListAppender // show the default appender, anormal, when not inserting a block
      , {
    ...
    value: function renderList() {
      ...
      var _this$props2 = this.props,
          ...
          shouldShowInsertionPointBefore = _this$props2.shouldShowInsertionPointBefore,
          shouldShowInsertionPointAfter = _this$props2.shouldShowInsertionPointAfter,
      ...
      var forceRefresh = shouldShowInsertionPointBefore || shouldShowInsertionPointAfter;
      var containerStyle = {
        flex: isRootList ? 1 : 0,
      ...
      return createElement(View, {
        ...
        style: [!isRootList && styles.overflowVisible, isStackedHorizontally && styles.horizontal, horizontalAlignment && styles["is-aligned-".concat(horizontalAlignment)]],
        data: blockClientIds,
    ...
    value: function renderItem(_ref) {
      ...
      var readableContentViewStyle = contentResizeMode === 'stretch' && {
        flex: 1
      };
...
export default compose([withSelect(function (select, _ref2) {
  ...
  var shouldShowInsertionPointAfter = function shouldShowInsertionPointAfter(clientId) {
    return !isStackedHorizontally && blockInsertionPointIsVisible && insertionPoint.rootClientId === rootClientId && // if the insertion point is at the end of the list
