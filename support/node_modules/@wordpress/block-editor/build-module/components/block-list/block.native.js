  ...
  _createClass(BlockListBlock, [{
    ...
    value: function render() {
      ...
      return createElement(TouchableWithoutFeedback, {
        ...
        style: [styles.solidBorder, getStylesFromColorScheme(styles.solidBorderColor, styles.solidBorderColorDark)]
...
export default compose([withSelect(function (select, _ref) {
  ...
  return {
    ...
    isDimmed: isDimmed,
    wrapperProps: blockType.getEditWrapperProps ? blockType.getEditWrapperProps(attributes) || {} : {}
  };
