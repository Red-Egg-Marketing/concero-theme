  ...
  content: [{
    ...
    innerBlocks: [{
      ...
      innerBlocks: [{
        ...
        attributes: {
          // translators: sample content for "About" page template
          value: "<p>".concat(__('The way to get started is to quit talking and begin doing.'), "</p>"),
          // translators: sample content for "About" page template
      ...
      innerBlocks: [{
        ...
        attributes: {
          // translators: sample content for "About" page template
          value: "<p>".concat(__('It is our choices, Harry, that show what we truly are, far more than our abilities.'), "</p>"),
          // translators: sample content for "About" page template
      ...
      innerBlocks: [{
        ...
        attributes: {
          // translators: sample content for "About" page template
          value: "<p>".concat(__('Don’t cry because it’s over, smile because it happened.'), "</p>"),
          // translators: sample content for "About" page template
