...
var Team = {
  ...
  content: [{
    ...
    attributes: {
      ...
      content: __('We are a small team of talented professionals with a wide range of skills and experience. We love what we do, and we do it with passion. We look forward to working with you.')
    }
  }, {
    name: 'core/spacer',
    attributes: {
    ...
    innerBlocks: [{
      ...
      attributes: {
        align: 'left',
        // translators: sample content for "Team" page template
        content: "<em>".concat(__('Position or Job Title'), "</em>"),
        dropCap: false,
        customFontSize: 16
      }
    }, {
      ...
      attributes: {
        align: 'left',
        // translators: sample content for "Team" page template
        content: __('A short bio with personal history, key achievements, or an interesting fact.'),
        dropCap: false,
        customFontSize: 16
      }
    }, {
      ...
      attributes: {
        align: 'left',
        // translators: sample content for "Team" page template
        content: __('Email me: <a href="mailto:mail@example.com">mail@example.com</a>'),
        dropCap: false,
        customFontSize: 16
      }
    }]
