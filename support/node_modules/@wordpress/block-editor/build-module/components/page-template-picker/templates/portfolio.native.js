...
var Portfolio = {
  ...
  content: [{
    ...
    attributes: {
      ...
      content: __('My portfolio showcases various projects created throughout my career. See my contact information below and get in touch.')
    }
  }, {
    name: 'core/spacer',
    attributes: {
    ...
    attributes: {
      align: 'left',
      // translators: sample content for "Portfolio" page template
      content: __('A description of the project and the works presented.')
    }
  }, {
    name: 'core/spacer',
    attributes: {
