...
var _blockElements = _interopRequireDefault(require("./block-elements"));
...
var BlockComponent = (0, _element.forwardRef)(function (_ref, wrapper) {
  ...
  var animationStyle = (0, _movingAnimation.default)(wrapper, isSelected || isPartOfMultiSelection, isSelected || isFirstMultiSelected, enableAnimation, index);
  /**
...
var ExtendedBlockComponent = _blockElements.default.reduce(function (acc, element) {
