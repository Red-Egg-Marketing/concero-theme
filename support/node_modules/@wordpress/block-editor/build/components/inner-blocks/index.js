  ...
  (0, _createClass2.default)(InnerBlocks, [{
    ...
    value: function render() {
      var _this$props5 = this.props,
          ...
          props = (0, _objectWithoutProperties2.default)(_this$props5, ["enableClickThrough", "clientId", "hasOverlay", "__experimentalCaptureToolbars", "forwardedRef", "block"]);
...
var ComposedInnerBlocks = (0, _compose.compose)([(0, _viewport.withViewportMatch)({
  isSmallScreen: '< medium'
}), (0, _context.withBlockEditContext)(function (context) {
  ...
  return {
    replaceInnerBlocks: function replaceInnerBlocks(blocks, forceUpdateSelection) {
      _replaceInnerBlocks(clientId, blocks, forceUpdateSelection !== undefined ? forceUpdateSelection : block.innerBlocks.length === 0 && templateInsertUpdatesSelection && blocks.length !== 0);
    },
...
var ForwardedInnerBlocks = (0, _element.forwardRef)(function (props, ref) {
  ...
  return (0, _element.createElement)(ComposedInnerBlocks, (0, _extends2.default)({}, props, {
