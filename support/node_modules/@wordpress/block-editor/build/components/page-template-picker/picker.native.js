...
var __experimentalPageTemplatePicker = function __experimentalPageTemplatePicker(_ref) {
  ...
  var onApply = function onApply() {
    ...
    (0, _reactNativeGutenbergBridge.logUserEvent)(_reactNativeGutenbergBridge.userEvents.editorSessionTemplateApply, {
  ...
  return (0, _element.createElement)(_reactNative.Animated.View, {
    ...
    return (0, _element.createElement)(_button.default, {
      ...
      onPress: function onPress() {
        (0, _reactNativeGutenbergBridge.logUserEvent)(_reactNativeGutenbergBridge.userEvents.editorSessionTemplatePreview, {
