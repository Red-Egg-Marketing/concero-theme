...
var BlockEditorProvider = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(BlockEditorProvider, _Component);

  var _super = _createSuper(BlockEditorProvider);
  ...
  (0, _createClass2.default)(BlockEditorProvider, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (this.isSyncingOutcomingValue.includes(value)) {
        ...
        // back on the editor.
        if ((0, _lodash.last)(this.isSyncingOutcomingValue) === value) {
          this.isSyncingOutcomingValue = [];
        }
    ...
    value: function attachChangeObserver(registry) {
      ...
      this.unsubscribe = registry.subscribe(function () {
        var _this$props2 = _this.props,
            ...
            onInput = _this$props2$onInput === void 0 ? _lodash.noop : _this$props2$onInput;
